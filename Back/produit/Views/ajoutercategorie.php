    ...
    <div id="right-panel" class="right-panel">
        ...
        <form action="" method="POST">
                    <div class="form-group">
                        <label for="id_categorie" class=" form-control-label">category idt</label>
                        
                        <input type="text" name="id_categorie" id="id_categorie" maxlength="20" placeholder="Enter your id event" class="form-control"></div>
                 
                    <div class="form-group">
                        <label for="nom_categorie" class=" form-control-label">category name</label>
                        <input type="text" name="nom_categorie" id="nom_categorie" placeholder="Enter category Name" class="form-control">
                    </div>
