            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="afficherproduit.php"> <i class="menu-icon fa fa-area-chart"></i>Produits</a>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="ajoutercategorie.php" > <i class="menu-icon fa fa-bar-chart"></i>Evénements</a>
                        <ul class="sub-menu children dropdown-menu">
...
?>
        ...
        <a href="ajoutercategorie.php"><button type="button" class="btn btn-primary">ajouter categorie</button></a>
