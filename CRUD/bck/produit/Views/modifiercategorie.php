        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="affichercategories.php" > <i class="menu-icon fa fa-bar-chart"></i>Evénements</a>
                        <ul class="sub-menu children dropdown-menu">
...
<form action="" method="POST">
                    <div class="form-group">
                        <label for="id_categorie" class=" form-control-label">ID category</label>
                        <input type="number" name="id_categorie" id="id_categorie" value="<?php echo $categorie['id_categorie']; ?>" maxlength="20" placeholder="Enter your category id" class="form-control"></div>
                    <div class="form-group">
                        <label for="nom_categorie" class=" form-control-label">category name</label>
                        <input type="text" name="nom_categorie" id="nom_categorie"  value="<?php echo $categorie['nom_categorie']; ?>" placeholder="Enter category name" class="form-control">
                    </div>
