    ...
    <div id="right-panel" class="right-panel">
        ...
        <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="id_evenement" id="id_evenement" maxlength="20" placeholder="Enter your id event" class="form-control"></div>
                    <div class="form-group">
                        <label for="date_evenement" class=" form-control-label">Date Evenement</label>
                        <input type="date" name="date_evenement" id="date_evenement" placeholder="Date" class="form-control"></div>
                    <div class="form-group">
                        <label for="duree" class=" form-control-label">Duree</label>
                        <input type="number" name="duree" id="duree" placeholder="Enter duree" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="nom_evenement" class=" form-control-label">Event Name</label>
                        <input type="text" name="nom_evenement" id="nom_evenement" placeholder="Enter Event Name" class="form-control">
                    </div>
