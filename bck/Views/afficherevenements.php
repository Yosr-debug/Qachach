...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="assets/assets/images/logo.png">
...
$total_pages_sql = "SELECT COUNT(*) FROM evenement";
$result = mysqli_query($conn,$total_pages_sql);
$total_rows = mysqli_fetch_array($result)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$sql = "SELECT * FROM evenement LIMIT $offset, $no_of_records_per_page";
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                    <a href="recherche.php" ><button type="button" class="btn btn-danger" >recherche</button><a>
                    <form action="" method="GET">
                        
                            
                        <input type="text"  name="tri" hidden value="1">
                        <input Type="submit" value="Trier" style="width:200px;" class="btn btn-primary">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="ajouterevenement.php" > <i class="menu-icon fa fa-bar-chart"></i>Evénements</a>
                        <ul class="sub-menu children dropdown-menu">
...
<?php
    ...
    if(isset($_GET['tri']))
    {$listeevenements=$evenementC->trierevenement();}
...
?>
		...
		<table  class="table" >
			...
			<tr>
				...
				<td><?php echo $evenement['duree']; ?></td>
				...
				<td>
					<a href="supprimerevenement.php?id_evenement=<?php echo $evenement['id_evenement']; ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
				</td>
        ...
        <footer class="site-footer">
                ...
                <div class="row">
                <ul class="pagination">
            <li><a href="?pageno=1"><button type="button" class="btn btn-success">First</button></a></li>
            <li></li>
            <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
                <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>"><button type="button" class="btn btn-success" style = "position:relative; left:20px;">Prev</button></a>
            </li>
            <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
                <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>"><button type="button" class="btn btn-success" style = "position:relative; left:40px;">Next</button></a>
            </li>
            <li><a href="?pageno=<?php echo $total_pages; ?>"><button type="button" class="btn btn-success" style = "position:relative; left:60px;">Last</button></a></li>
            </ul>
                </nav>
