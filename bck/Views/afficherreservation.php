...
?>
		...
		<table class="table table-dark" border="1" align="center">
			...
			<tr>
				...
				<td><?php echo $reservation['nbr_place']; ?></td>
				<td><?php echo $reservation['date_reservation']; ?></td>
   
                <td><a href="supprimerreservation.php?id_reservation=<?php echo $reservation['id_reservation']; ?>"><button type="button" class="btn btn-danger">Supprimer</button></a></td>
