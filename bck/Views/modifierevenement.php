...
if (
    ...
    if (
        ...
        $evenementC->modifierevenement($evenement, $_POST["id_evenement"]);
...
<aside id="left-panel" class="left-panel">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="pages/produits.html"> <i class="menu-icon fa fa-area-chart"></i>Produits</a>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="afficherevenements.php" > <i class="menu-icon fa fa-bar-chart"></i>Evénements</a>
                        <ul class="sub-menu children dropdown-menu">
    ...
    if (isset($_POST['id_evenement'])) {
        $evenement = $evenementC->recupererevenement($_POST['id_evenement']);

    ?>

<form action="" method="POST">
                    <div class="form-group">
                        <label for="id_evenement" class=" form-control-label">ID event</label>
                        
                        <input type="text" name="id_evenement" id="id_evenement" value="<?php echo $evenement['id_evenement']; ?>" maxlength="20" placeholder="Enter your id event" class="form-control" style="width:170px"></div>
                    <div class="form-group">
                        <label for="date_evenement" class=" form-control-label">Date Evenement</label>
                        <input type="date" name="date_evenement" id="date_evenement" value="<?php echo $evenement['date_evenement']; ?>" placeholder="Date" class="form-control" style="width:170px"></div>
                    <div class="form-group">
                        <label for="duree" class=" form-control-label">Duree</label>
                        <input type="number" name="duree" id="duree" value="<?php echo $evenement['duree']; ?>" placeholder="Enter duree" class="form-control" style="width:170px">
                    </div>
                    <div class="form-group">
                        <label for="nom_evenement" class=" form-control-label">Event Name</label>
                        <input type="text" name="nom_evenement" id="nom_evenement"  value="<?php echo $evenement['nom_evenement']; ?>" placeholder="Enter Event Name" class="form-control" style="width:170px">
                    </div>
                    <input type="submit" class="btn btn-primary" value="Envoyer">
                    <a href="afficherevenements.php" ><input type="button" class="btn btn-danger" value="Annuler" ></a>
                </form>
