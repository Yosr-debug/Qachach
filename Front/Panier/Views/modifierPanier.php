<?php
    ...
    if (
        ...
        if (
            ...
            $panierC->modifierPanier($panier, $_POST["id_panier"]);
    ...
    <button><a href="afficherPanier.php">Retour à la liste des paniers</a></button>
        ...
        ><?php
			if (isset($_POST['id_panier'])){
				$panier = $panierC->recupererPanier($_POST['id_panier']);
        ...
        <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="number" name="id_panier" id="id_panier" value="<?php echo $panier['id_panier']; ?>" maxlength="20" placeholder="Enter your id event" class="form-control"></div>
                    <div class="form-group">
                        <label for="prixT" class=" form-control-label">prixT</label>
                        <input type="number" name="prixT" id="prixT" value="<?php echo $panier['prixT']; ?>" placeholder="Prix" class="form-control"></div>
                    <div class="form-group">
                        <label for="id_user" class=" form-control-label">id user</label>
                        <input type="number" name="id_user" id="id_user" value="<?php echo $panier['id_user']; ?>" placeholder="id user" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="id_produit" class=" form-control-label">id produit</label>
                        <input type="number" name="id_produit" id="id_produit" value="<?php echo $panier['id_produit']; ?>" placeholder="id produit" class="form-control">
                    </div>
