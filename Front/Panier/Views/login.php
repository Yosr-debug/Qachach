...
{
    $listePanier=$panierC->rechercherpanier($_GET['recherche']);
}
?>
<!DOCTYPE html>
<html>
...
<header class="header-area header-sticky">
    ...
    <div  style="position:relative; top: 120px;">
       <form action="afficherPanier.php" method="GET">
       <div class="mb3">
      <label class="form-label" > Login</label>
        <input type="text" name="recherche">
       <button type="research" value="Rechercher" class="btn btn-primary">Submit</button>
    </div>
       </form>
    </div>
